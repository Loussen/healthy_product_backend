...
<head>
    ...
    <title>Healthy Product - Sağlıklı Yaşam İçin Ürün Analizi</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="images/hero-app.png" alt="App Screenshot" class="img-fluid hero-image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features" class="features">
        <div class="container">
            <div class="text-center mb-5">
                <h2>Neden Healthy Product?</h2>
                <p class="lead">Sağlıklı yaşam için ihtiyacınız olan tüm özellikler</p>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <p>Alerjilerinizi ve tercihlerinizi belirleyin, size özel öneriler alın.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="download-image">
                        <img src="images/app-screens.png" alt="App Screenshots" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="mb-0">&copy; 2024 Healthy Product. Tüm hakları saklıdır.</p>
                </div>
            </div>
        </div>
    </footer>
